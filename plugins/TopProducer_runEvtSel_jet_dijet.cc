...
void TopProducer::branchesEvtSel_jet_dijet( TTree* tree, edm::Service<TFileService> &fs ) {
...
bool TopProducer::runEvtSel_jet_dijet( const edm::Event& iEvent, const edm::EventSetup& iSetup )
{
...
void TopProducer::fillEvtSel_jet_dijet( const edm::Event& iEvent, const edm::EventSetup& iSetup ) {
